...
export default function Home() {
  // Google OAuth2 URL
  const googleAuthUrl = `https://accounts.google.com/o/oauth2/v2/auth?client_id=426029757498-e2h60b5m0fretoj56judho6j906n7lea.apps.googleusercontent.com&redirect_uri=https%3A%2F%2Frrishi-connect.com%2Foauth2%2Fcallback&response_type=code&scope=https%3A%2F%2Fwww.googleapis.com%2Fauth%2Fcalendar&access_type=offline&prompt=consent`;
